...
class COODModel:
    ...
    def __init__(
        ...
        :param ood_images_dir: Path to the directory containing out-of-distribution images for reference/training. If
        ...
        self.ood_classifier = None  # The C-OOD random forest classifier

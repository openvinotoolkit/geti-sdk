...
#. Provide an easy-to-use interface to the Intel® Geti™ platform, to be able to
   manipulate Intel® Geti™ projects and other entities or automate tasks on the platform. All
...
#. Provide an API to deploy and run models trained on the Intel® Geti™ server on your local
   ...
   route to create a deployment for your Intel® Geti™ project, save it to local disk and run
   it offline.

...
class EntityIdentifier:
    """
    Identifying information for a configurable entity in SC, as returned by the
...
class HyperParameterGroupIdentifier(EntityIdentifier):
    """
    Identifying information for a HyperParameterGroup in SC, as returned by the
    /configuration endpoint.
...
class ComponentEntityIdentifier(EntityIdentifier):
    """
    Identifying information for a configurable Component in SC, as returned by the
    /configuration endpoint.
